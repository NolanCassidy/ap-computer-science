...
public class Picture extends SimplePicture
{
	...
	public void mirrorGull()
	{
		...
		for (int row = 235; row < 323; row++)
			for (int col = 238; col < mirrorPoint; col++)
			{
				...
				leftPixel = pixels[row][mirrorPoint - col + mirrorPoint / 4];
				leftPixel.setColor(rightPixel.getColor());
			}
	...
	public void myCollage()
	{
		...
		Picture caterpillar3 = new Picture("caterpillar.jpg");
		
		caterpillar1.mirrorDiagonal();
		caterpillar2.zeroBlue();
		caterpillar3.mirrorHorizontal();
		
		caterpillar1.scale(.5, .5);
		caterpillar2.scale(.5, .5);
		caterpillar3.scale(.5, .5);
		
		this.copy2(caterpillar1, 0, 100, 0, 100);
		this.copy2(caterpillar2, 150, 250, 150, 250);
		this.copy2(caterpillar3, 300, 400, 300, 400);
	}
